...
<link rel="stylesheet" href="<c:url value='/resources/css/admin/deleteForm.css'/>">
<link rel="stylesheet" href="<c:url value='/resources/css/admin/idFind.css'/>">
<link rel="stylesheet" href="<c:url value='/resources/css/admin/insertForm.css'/>">
<link rel="stylesheet" href="<c:url value='/resources/css/admin/loginForm.css'/>">
<link rel="stylesheet" href="<c:url value='/resources/css/admin/myPage.css'/>">
<link rel="stylesheet" href="<c:url value='/resources/css/admin/style.css'/>">
<link rel="stylesheet" href="<c:url value='/resources/css/admin/updateForm.css'/>">
          ...
          <nav>
              <ul id="topMenu">
                  <li><a href="#">HELP <span>▼</span></a>
                      <ul>
                          <li><a href="<c:url value='/admin/notice/list2.do' />">공지사항</a></li>
                          <li><a href="<c:url value='/admin/board/list2.do' />">회원 게시판</a></li>
                          <li><a href="<c:url value='/admin/member/list.do' />">회원 전체 조회</a></li>
                      </ul>
                  </li>
                  <li>
